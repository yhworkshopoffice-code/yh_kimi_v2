        ...
        <div className="grid grid-cols-1 lg:grid-cols-4 gap-8">
          ...
          <div className="lg:col-span-1">
            ...
            <div className="space-y-1">
              ...
              <button className="w-full flex items-center gap-3 px-4 py-3 rounded-lg text-left text-slate-400 hover:bg-slate-800 hover:text-red-400 transition-colors">
          ...
          <div className="lg:col-span-3">
            ...
            {activeTab === "settings" && (
              <div className="space-y-6">
                <h1 className="text-2xl font-bold text-white">帳號設定</h1>
                <Card className="bg-slate-900 border-slate-800">
                  <CardHeader>
                  ...
                  <CardContent className="space-y-4">
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                      <div className="space-y-2">
                        ...
                        <Input defaultValue={userData.name} className="bg-slate-800 border-slate-700 text-white" />
                      </div>
                      <div className="space-y-2">
                        <Label className="text-slate-300">手機</Label>
                        <div className="relative">
                          <Phone className="absolute left-3 top-1/2 -translate-y-1/2 w-4 h-4 text-slate-500" />
                          <Input defaultValue={userData.phone} className="pl-10 bg-slate-800 border-slate-700 text-white" />
                        </div>
                      </div>
                    </div>
                    <div className="space-y-2">
                      ...
                      <div className="relative">
                        ...
                        <Input defaultValue={userData.email} className="pl-10 bg-slate-800 border-slate-700 text-white" />
                      </div>
                    </div>
                    <Button className="bg-cyan-500 hover:bg-cyan-600">保存變更</Button>
                  </CardContent>
                </Card>

                <Card className="bg-slate-900 border-slate-800">
                  <CardHeader>
                    <CardTitle className="text-white">修改密碼</CardTitle>
                  </CardHeader>
                  <CardContent className="space-y-4">
                    <div className="space-y-2">
